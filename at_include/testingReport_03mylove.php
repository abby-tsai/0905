...
<div class="reportItem noBG">
	<div class="reportDetial">
		<div class="reportChart canvas5">
			...
			<ul><li>肯定的語言</li><li>精心的時刻</li><li>接受禮物</li><li>服務的行動</li><li>身體的接觸</li></ul>
		</div>
		<script>			
			/* Canvas */
			var canvas = document.getElementById("CG_star");
			var ctx = canvas.getContext("2d");
			var reportValue = [80,21,98,67,100]; // 測驗報告參數 0 ~ 100
			var i,bg,
				c_w = canvas.width,
				c_h = canvas.height,
				center = c_w*0.5,
...
<div class="reportItem">
	...
	<div class="reportDetial">
		<div class="script">
			妳是一個實際的人。相較於鮮花浪漫、禮物溫存，妳更重視的是他能不能幫妳的忙。例如，一起處理一些瑣事、用一些具體行動協助妳完成工作、做家事、準備飯菜、或整理環境等等，會讓妳感覺到自己在這段關係裡是被呵護、被了解、被重視的。尤其當他投入地在幫忙，或是犧牲自己的一些時間完成妳交付的事情時，妳更會深切地感受到對方是重視妳的。
		</div>
		<div class="title">關於妳的愛之語，另一半可以怎麼做？</div>
		<div class="script">
			正因為我們是如此的不足，所以才能在彼此的生命裡，為對方作一點事情。服務的行動並非要替對方作牛作馬，而是要作一些「真正對妳來說重要，又能讓妳感覺到愛的事情」，它沒有送禮或讚美這麼多種形式，相對的，它需要一套流程來完成。<br><br>
			a.服務清單：可以每個月請妳寫下妳最希望也最需要他幫妳完成的十件事，如果一個月考慮的太長，也可以改成一週三件，然後按重要性排序，從重要的先完成。<br><br>
			b.窩心卡：當他做完一件事情（例如擦地板、帶小孩、幫他整理客戶資料等等）之後，可以在一張心型小卡（自己剪）或便利貼上寫上「給xx愛的禮物」，貼在相關的物品上或妳會看見的地方（拖把、冰箱、他的筆記型電腦，但千萬別貼小孩頭上）。<br><br>
			c.把小事情，變成小確幸：魔鬼藏在細節裡，有些服務的行動其實相當簡單，但經常因為忽略變成爭執的導火線，例如撿起浴室排水孔的頭髮，上完廁所掀起馬桶蓋，用完東西放回原位等等，一般來說妳「經常嘮叨」的是什麼，就是妳覺得最重要的事，也把它寫入「服務清單」裡，並先從它做起。
		</div>
	</div>
</div>
<div class="reportItem">
