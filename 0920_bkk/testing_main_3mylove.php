...
<div id="main">
	<div class="headerBack">
		<a class="back"><i class="fa fa-angle-left" aria-hidden="true"></i>愛之語測驗</a>
    </div>
        ...
        <div class="testingPad">
            <div class="testingStart">
				<ul>
					...
					<li class="script">(版權所有©2005中國主日學協會《單身愛之語》/蓋瑞．巧門，經中國主日學協會同意准予使用。)</li>
				</ul>
            </div>
            <form action="testing_main_3report.php">
        	<div class="pageGroup">
                <?php include_once("at_include/testingCount_03mylove.php"); ?>    
        	</div>
        	</form>
        </div>        
    	<!-- 以上可以用資料庫 END -->
