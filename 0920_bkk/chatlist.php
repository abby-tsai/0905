...
<div id="main">
	<div class="headerBack">
		<a class="back"><i class="fa fa-angle-left" aria-hidden="true"></i>訊息</a>
    </div>
    <div class="chatlistCount pairReport">
        <div class="chatlistPad headerListPop">
			<?php include("at_include/data_chatlist.php"); ?>
        </div>
...
<!-- jQuery -->    
    ...
    <script>
		...
		$(document).ready(function() {
			$('.subHeader').find('li.menu_chat').addClass('active');
