    ...
    <div class="meetListCount">
        <div class="meetListPad clear">
			...
			<div class="meetChatItem">
				<div class="timer">11/30, 14:30</div>
				<div class="mypairItem">
					<ul class="picture"><img alt="" src="images/user_photo_default_l.png" /></ul>
					...
					<a href="" class="btn_meet active"><span>可以</span><p>見面聊</p></a>
				</div>				
				<div class="meetCtrlPad">
					<a class="btn_accepted">接受邀請<span>到訊息室敲定細節</span></a>
				</div>
			</div>       
