...
<div id="main">
	<div class="headerBack">
		<a class="back"><i class="fa fa-angle-left" aria-hidden="true"></i>愛情風格測驗</a>
    </div>
    ...
    <div class="testingCount">
        ...
        <div class="testingPad">
            ...
            <form action="testing_main_5report.php">
        	<div class="pageGroup">
                <?php include_once("at_include/testingCount_04lovestyle.php"); ?>    
        	</div>
        	</form>
        </div>        
    	<!-- 以上可以用資料庫 END -->
