...
<div id="main">
	<div class="wt_loginPad">
		...
		<form>
			<div class="inputPad">
				<ul class="inputData">
					<li><input type="password" placeholder="舊密碼" /></li>
					<li><input type="password" placeholder="新密碼" /></li>	
					<li><input type="password" placeholder="確認新密碼" /></li>			
				</ul>
				<ul class="inputSumit">
					<li><input type="submit" value="完成" /></li>
				</ul>
			</div>
		</form>
	</div>
