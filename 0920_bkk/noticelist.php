...
<body class="noticelist">
<div id="fb-root"></div>
<?php include_once("at_include/header.php"); ?>
<div id="main">
	<div class="headerBack">
		<a class="back"><i class="fa fa-angle-left" aria-hidden="true"></i>訊息通知</a>
    </div>
    <div class="noticelistCount pairReport">
        <div class="noticelistPad headerListPop">
			<?php include("at_include/data_noticelist.php"); ?>
        </div>
    </div><!-- chatlistCount END -->
</div><!-- main END -->
...
<!-- jQuery -->    
    ...
    <script>
		...
		$(document).ready(function() {
			$('.subHeader').find('.menu_mesg').addClass('active');
